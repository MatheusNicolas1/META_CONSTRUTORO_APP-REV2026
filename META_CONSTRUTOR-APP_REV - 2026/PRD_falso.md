...
|
|| FALSO-055 | Marketing - metricas hardcoded em pages-gemini | `src/pages-gemini/Home2.tsx`, `src/pages-gemini/Sobre2.tsx`, `src/pages/Index.tsx`, `src/pages/Sobre.tsx`, `src/pages/Captura.tsx` | Rotas `/home2` e `/sobre2` ativas via lazy loading exibiam numeros hardcoded de marketing sem fonte auditavel: "1.500+ obras", "300+ construtoras", "98% satisfacao" (em ambas) e "50k+ RDOs" (apenas em Sobre2/Metrics). VARREdura 2026-07-31 revelou que o mesmo padrao TAMBEM persistia nas paginas principais (`/home` Index.tsx: 1.500+/300+/50k+/98% em stats+TrustBar; `/sobre` Sobre.tsx: 300+/1.500+/50k+ em metrics) e em `/captura` (Captura.tsx: "450+ construtoras", "4.9 de avaliacao", "4.9/5.0 mais de 1.250 avaliacoes") — ou seja, FALSO-036 (2026-06-02) foi correcao INCOMPLETA e as metricas voltaram (possivelmente reintroduzidas no UI/UX refactor 2026-07-30). | P1 - alto, por replicar promessa comercial ficticia em superficies publicas ativas. | Corrigido 2026-07-31 em 5 arquivos (aplicada mesma correcao do FALSO-036 = remocao de numeros sem origem): removidos stats/StatItem/TrustBar (Index), metrics/Metrics JSX (Sobre), MetricCounter/trust badges/METRICS STRIP/claim CTA "300 construtoras" (Home2), METRICS/Metrics JSX/claims VALUES e TIMELINE numericas/CTA "300 construtoras" (Sobre2), claims "450+ construtoras"/"4.9 avaliacao"/"4.9/5.0 - 1.250 avaliacoes" (Captura). Mantidos itens factuais: "100% gratuito" (Captura - modelo CSV gratis) e "2023 Fundacao" (Sobre). Substituicoes textuais nos CTAs mantendo layout. Typecheck (tsc) exit 0, build (vite) exit 0. | Corrigido (deploy) |
| FALSO-055 (EXPANDIDO 2026-07-31) | Varredura de producao (bundle real) revelou +4 residuos nao pegos na verificacao de codigo-fonte | `src/config/seo.ts`, `src/pages-gemini/Contato2.tsx`, `src/components/capture/RDOExcelSimulator.tsx`, `src/pages/Index.tsx`, `src/remotion/compositions/SocialProof.tsx` | Mesmo padrao FALSO-055 (claims numericas sem fonte) em: seo.ts:342 (meta /sobre com "1.500 obras"), Contato2.tsx:227 (hero "1.500 obras"), RDOExcelSimulator.tsx:367 ("450 construtoras"), Index.tsx:270 typewriter ("300 construtoras"), e composicao de VIDEO marketing Remotion SocialProof.tsx ("1.500+ obras/300+ construtoras/50k+ RDOs/98% satisfacao"). | P1 - alto, por replicar promessa comercial ficticia em superficie publica (inclui meta tags de SEO e material de video). | Corrigido 2026-07-31: claims removidas/substituidas por recursos reais; stats do SocialProof viram recursos ("RDO digital/ Grátis/ PDF automático/ 100% dados na nuvem"). Commit f7b85ad. Typecheck exit 0, build exit 0, deploy Vercel concluido e bundle de producao verificado (claims = 0 nos 142 chunks + bundle principal). | Corrigido (deploy) |
|| FALSO-056 | Marketing - pricing ficticio no /preco2 (pages-gemini) | `src/pages-gemini/Preco2.tsx` | Rota `/preco2` ativa via lazy loading exibia planos e precos que NAO existem no app: "Profissional R$79 (R$63 anual)" e "Enterprise R$299 (R$239 anual)", além de omitir o plano Básico real (R$129,90). Precos reais (Preco.tsx): Grátis R$0, Básico R$129,90/R$1.247,04 ano, Profissional R$199,90/R$1.919,04 ano, Master R$347,00/R$3.331,20 ano, Enterprise sob consulta. CTAs dos cards e do hero ("Assinar Agora", "Falar no WhatsApp") nao tinham link/acao. | P0 - alto, por divulgar cobranca (preco/plano) ficticia em superficie publica de venda ativa. | Correto 2026-07-31: PLANS/COMPARISON_ROWS/FAQ_ITEMS reescritos com os 5 planos reais; grid de 3 p/ 5 cards; tabela com 5 colunas reais; CTAs agora usam `<a href>` para /checkout?plan=* e /contato; sufixo "/mês" omitido para "Sob consulta". Caracteres do pricing ficticio antigo (R$79/299/63/239) confirmados AUSENTES em todo src/. | Corrigido (deploy) |
| FALSO-056 (RECORRENTE 2026-07-31) | Pricing ficticio veiculado em blog + SEO | `src/content/blogArticles.pt-BR.ts`, `src/config/seo.ts` | Blog inteiro replicava o pricing falso do antigo Preco2.tsx em 10+ artigos publicos (RDO/gestao/financiamento): "Profissional R$79/mes", "R$ 89/mes", "R$ 79/mes por obra", "plano gratuito com RDO ilimitado e 3 usuarios", "mais de 500 construtoras". seo.ts:320 e 330 (meta + FAQ do /preco2) veiculavam "Profissional R$79 (R$63 anual)/Enterprise R$299 (R$239 anual)". | P0 - alto, por divulgar cobranca ficticia em conteudo publico indexado por SEO (blog e meta tags), arriscando conversao e confianca no MVP. | Corrigido 2026-07-31: ~12 ocorrencias de pricing ajustadas para os valores REAIS (Básico R$129,90/Profissional R$199,90/Master R$347/Enterprise sob consulta); claim "500 construtoras" removida; plano gratuito descrito conforme planLimits real (1 obra/1 usuario/7 RDOs mensais); meta+FAQ do /preco2 reescritos com os 5 planos reais. Commit f7b85ad. Typecheck exit 0, build exit 0, deploy e verificado em producao (precos reais presentes; R$79/299 ausentes como preco do Meta). | Corrigido (deploy) |