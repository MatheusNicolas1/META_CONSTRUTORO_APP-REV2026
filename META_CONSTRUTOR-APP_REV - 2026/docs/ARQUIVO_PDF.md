    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-right">
                <div class="header-info"><span class="header-info-label">RDO Nº:</span> 2024-001</div>
                <div class="header-info"><span class="header-info-label">Código da Obra:</span> OBR-2024-0001</div>
        ...
        <div class="section">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">Edifício Comercial - Centro da Cidade</div>
                </div>
            </div>
            <div class="info-grid full">
                <div class="info-item">
                    <span class="info-label">Condições Climáticas</span>
                    <div class="info-value">☀️ Manhã: Claro | ⛅ Tarde: Nublado</div>
                </div>
            </div>
            <div class="info-grid full">
                <div class="info-item">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>Equipe de Fundação</td>
                        <td>João Silva</td>
                        <td>Pedro, Ana, Marcos, Sofia, Carlos</td>
                        <td>Escavação e Fundação</td>
                    </tr>
                    <tr>
                        <td>Equipe de Estrutura</td>
                        <td>Carlos Santos</td>
                        <td>Fernanda, Ricardo, Paula, Bruno, Gabriela, Rafael, Juliana, Felipe</td>
                        <td>Armação e Concretagem</td>
                    </tr>
                    <tr>
                        <td>Equipe de Acabamento</td>
                        <td>Maria Oliveira</td>
                        <td>Lucas, Patrícia, Daniel, Camila, André, Beatriz</td>
                        <td>Alvenaria e Revestimento</td>
                    </tr>
                </tbody>
            </table>
            <!-- Exemplo de seção vazia -->
        ...
        <div class="section">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>Escavação de Fundações</td>
                        <td>João Silva</td>
                        <td><span class="status-badge status-concluida">✅ Concluída</span></td>
                        <td>100%</td>
                        <td>Concluída conforme planejado</td>
                    </tr>
                    <tr>
                        <td>Forma de Fundação</td>
                        <td>Carlos Santos</td>
                        <td><span class="status-badge status-andamento">🔄 Em Andamento</span></td>
                        <td>75%</td>
                        <td>Atraso de 2 horas por falta de material</td>
                    </tr>
                    <tr>
                        <td>Concretagem de Fundação</td>
                        <td>Carlos Santos</td>
                        <td><span class="status-badge status-nao-iniciada">⏳ Não Iniciada</span></td>
                        <td>0%</td>
                        <td>Aguardando conclusão da forma</td>
                    </tr>
                    <tr>
                        <td>Limpeza do Canteiro</td>
                        <td>Maria Oliveira</td>
                        <td><span class="status-badge status-concluida">✅ Concluída</span></td>
                        <td>100%</td>
                        <td>Realizada no final do expediente</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>Reparação de Escora</td>
                        <td>Segurança da Obra</td>
                        <td>João Silva</td>
                        <td>14:30 - 15:15</td>
                    </tr>
                    <tr>
                        <td>Ajuste de Gabarito</td>
                        <td>Correção de Alinhamento</td>
                        <td>Carlos Santos</td>
                        <td>10:00 - 10:45</td>
                    </tr>
                </tbody>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Betoneira 400L</td>
                        <td>2</td>
                        <td>13:00 - 17:30</td>
                        <td>Lucas Ferreira</td>
                        <td>Pequeno vazamento - manutenção agendada</td>
                    </tr>
                    <tr>
                        <td>Guindaste Móvel</td>
                        <td>1</td>
                        <td>08:00 - 11:00</td>
                        <td>Roberto Costa</td>
                        <td>Funcionamento normal</td>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>Segurança</td>
                        <td>Colaborador sem EPI no canteiro</td>
                        <td>João da Silva</td>
                        <td>Repreensão e orientação sobre uso de EPI</td>
                        <td><span class="status-badge status-resolvido">✅ Resolvido</span></td>
                        <td>09:30</td>
                    </tr>
                    <tr>
                        <td>Material</td>
                        <td>Falta de areia para concretagem</td>
                        <td>Fornecedor ABC</td>
                        <td>Contato com fornecedor para entrega urgente</td>
                        <td><span class="status-badge status-pendente">⏳ Pendente</span></td>
                        <td>11:00</td>
                    </tr>
                    <tr>
                        <td>Equipamento</td>
                        <td>Betoneira com vazamento de óleo</td>
                        <td>Manutenção</td>
                        <td>Agendada manutenção preventiva para amanhã</td>
                        <td><span class="status-badge status-pendente">⏳ Pendente</span></td>
                        <td>14:15</td>
                    </tr>
                    <tr>
                        <td>Qualidade</td>
                        <td>Desalinhamento em forma de fundação</td>
                        <td>Equipe de Estrutura</td>
                        <td>Reposicionamento e verificação com nível</td>
                        <td><span class="status-badge status-resolvido">✅ Resolvido</span></td>
                        <td>10:45</td>
                    </tr>
                </tbody>
        ...
        <div class="section">
            ...
            <div class="observations-box">Dia produtivo com bom andamento das atividades planejadas. Equipes trabalharam em harmonia e cumpriram as metas estabelecidas. Pequenos atrasos na forma de fundação foram compensados com hora extra no final do dia. Clima favorável durante todo o período. Recomenda-se dar continuidade ao cronograma previsto para amanhã com a concretagem da fundação. Todos os colaboradores apresentaram bom desempenho e comprometimento com a segurança.</div>
        </div>

        <!-- CAMPO ELABORADO POR -->
        <div class="identification-field">
            <strong>Elaborado por:</strong> Ana Paula Souza - Engenheira Civil - 15/03/2024 18:00
        </div>

        <!-- SEÇÃO 8: ANEXOS -->
        <div class="section">
            <div class="section-title">8. Anexos</div>
            <p class="attachment-counter">📎 Total de 5 arquivos anexados</p>
            
            <h4 style="font-size: 9.5pt; font-weight: 600; color: #0066cc; margin-bottom: 8px;">Imagens</h4>
            <div class="gallery">
                <div class="gallery-item">
                    <div style="width: 100%; height: 70px; background-color: #e0e0e0; border: 1px solid #ccc; border-radius: 3px; display: flex; align-items: center; justify-content: center; color: #999; font-size: 9pt;">📷 Imagem 1</div>
                    <div class="gallery-caption">Fundação - Estado Geral</div>
                </div>
                <div class="gallery-item">
                    <div style="width: 100%; height: 70px; background-color: #e0e0e0; border: 1px solid #ccc; border-radius: 3px; display: flex; align-items: center; justify-content: center; color: #999; font-size: 9pt;">📷 Imagem 2</div>
                    <div class="gallery-caption">Forma de Fundação</div>
                </div>
                <div class="gallery-item">
                    <div style="width: 100%; height: 70px; background-color: #e0e0e0; border: 1px solid #ccc; border-radius: 3px; display: flex; align-items: center; justify-content: center; color: #999; font-size: 9pt;">📷 Imagem 3</div>
                    <div class="gallery-caption">Equipe em Ação</div>
                </div>
                <div class="gallery-item">
                    <div style="width: 100%; height: 70px; background-color: #e0e0e0; border: 1px solid #ccc; border-radius: 3px; display: flex; align-items: center; justify-content: center; color: #999; font-size: 9pt;">📷 Imagem 4</div>
                    <div class="gallery-caption">Vista Aérea do Canteiro</div>
                </div>
            </div>
            ...
            <div class="attachment-item">
                ...
                <div class="attachment-info">
                    <div class="attachment-name">Relatório_Seguranca_15_03_2024.pdf</div>
                    <div class="attachment-meta">PDF | 2.5 MB</div>
                </div>
            </div>
            <div class="attachment-item">
                <div class="attachment-icon">📊</div>
                <div class="attachment-info">
                    <div class="attachment-name">Planilha_Horas_Trabalho.xlsx</div>
                    <div class="attachment-meta">Planilha | 1.2 MB</div>
                </div>
            </div>
            <!-- <div class="empty-message">Nenhum registro nesta seção.</div> -->
        </div>
        ...
        <!-- CAMPO APROVADO POR -->
        <div class="identification-field" style="background-color: #e6ffe6; border-color: #99cc99;">
            <strong>Aprovado por:</strong> Pedro Almeida - Gerente de Projetos - 15/03/2024 19:30
        </div>
        ...
        <div style="text-align: center; margin-top: 20px; font-size: 7pt; color: #999; border-top: 1px solid #ddd; padding-top: 10px;">
            <p>Página <span class="page-number"></span> de <span class="total-pages"></span> | Gerado em 15/03/2024 às 18:45</p>
        </div>
    </div>
</body>
</html>