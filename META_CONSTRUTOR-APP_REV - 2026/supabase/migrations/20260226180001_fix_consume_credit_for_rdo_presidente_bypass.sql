...
-- ============================================================
-- FIX: consume_credit_for_rdo deve ignorar role = 'Presidente'
-- e qualquer role administrativa (Administrador / Presidente)
-- que tenha acesso ilimitado, independente do plan_type.
-- ============================================================
...
DECLARE
  ...
  v_credits INTEGER;
BEGIN
  -- 1. Buscar role do usuário no profiles
