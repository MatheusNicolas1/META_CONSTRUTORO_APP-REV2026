...
-- ============================================================================
-- 7. Backfill para usuários existentes sem perfil de afiliado
-- ============================================================================
DO $$
DECLARE
    user_record RECORD;
...
-- ============================================================================
-- 8. Função: incrementar contador de cliques do afiliado
-- ============================================================================
...
-- ============================================================================
-- 9. Função: processar referral ao criar conta
-- ============================================================================
...
BEGIN
    ...
    INSERT INTO public.affiliate_referrals (
        affiliate_id, referred_user_id, referred_email, status
    ) VALUES (
        v_affiliate_id, p_referred_user_id, p_referred_email, 'pending'
...
-- ============================================================================
-- 10. Função: gerar comissão a partir de pagamento aprovado
-- ============================================================================
...
BEGIN
    ...
    INSERT INTO public.affiliate_commissions (
        affiliate_id, referral_id, subscription_id,
        stripe_invoice_id, gross_amount, net_amount,
        amount, percentage, status
    ) VALUES (
        v_affiliate_id, p_referral_id, p_subscription_id,
        p_stripe_invoice_id, p_gross_amount, p_net_amount,
        v_amount, v_percentage, 'pending'
...
-- ============================================================================
-- 11. Função: cancelar comissão (cancelamento/reembolso)
-- ============================================================================
...
BEGIN
    ...
    SET status = CASE
        ...
        END,
        cancelled_at = now()
    WHERE id = (SELECT referral_id FROM public.affiliate_commissions WHERE id = v_commission_id);
